...
! function(t) {
    ...
    x.ui = x.ui || {};
    var s, C, E, n, o, l, a, r, i;
    x.ui.version = "1.12.1", x.ui.keyCode = {
        BACKSPACE: 8,
        COMMA: 188,
        DELETE: 46,
        DOWN: 40,
    ...
    C = Math.max, E = Math.abs, n = /left|center|right/, o = /top|center|bottom/, l = /[\+\-]\d+(\.[\d]+)?%?/, a = /^\w+/, r = /%$/, i = x.fn.position, x.position = {
        ...
        return g[0].preventDefault && (c.at = "left top"), f = e.width, m = e.height, p = e.offset, v = x.extend({}, p), x.each(["my", "at"], function() {
            ...
            1 === i.length && (i = n.test(i[0]) ? i.concat(["center"]) : o.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = n.test(i[0]) ? i[0] : "center", i[1] = o.test(i[1]) ? i[1] : "center", t = l.exec(i[0]), e = l.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], c[this] = [a.exec(i[0])[0], a.exec(i[1])[0]]
        }), 1 === b.length && (b[1] = b[0]), "right" === c.at[0] ? v.left += f : "center" === c.at[0] && (v.left += f / 2), "bottom" === c.at[1] ? v.top += m : "center" === c.at[1] && (v.top += m / 2), d = k(w.at, f, m), v.left += d[0], v.top += d[1], this.each(function() {
            var i, t, l = x(this),
                a = l.outerWidth(),
                r = l.outerHeight(),
                e = T(this, "marginLeft"),
                s = T(this, "marginTop"),
                n = a + e + T(this, "marginRight") + y.width,
                o = r + s + T(this, "marginBottom") + y.height,
                u = x.extend({}, v),
                h = k(w.my, l.outerWidth(), l.outerHeight());
    ...
    x.cleanData = (u = x.cleanData, function(t) {
        ...
        _createWidget: function(t, e) {
            e = x(e || this.defaultElement || this)[0], this.element = x(e), this.uuid = h++, this.eventNamespace = "." + this.widgetName + this.uuid, this.bindings = x(), this.hoverable = x(), this.focusable = x(), this.classesElementLookup = {}, e !== this && (x.data(e, this.widgetFullName, this), this._on(!0, this.element, {
                remove: function(t) {
    ...
    x.widget, x.ui.safeActiveElement = function(e) {
        var i;
        try {
            i = e.activeElement
        } catch (t) {
